        ...
        <>
          {visibleTiles?.length>0?
            <div className={styles.gridContainer}>
                <a onClick={scrollUp} className={`${styles.arrowUp} ${styles.arrowUp_inversion}`}>
